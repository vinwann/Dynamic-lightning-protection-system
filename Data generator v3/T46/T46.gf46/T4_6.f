...
! 10:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '46_1'
      IF (FIRSTSTEP) RTCF(NRTCF+3) = 5.0
      CALL SURGE_IEEE1_EXE(RT_1)

! 20:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '46_2'
      IF (FIRSTSTEP) RTCF(NRTCF+3) = 0.0
      CALL SURGE_IEEE1_EXE(RT_2)

! 30:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '46_3'
      IF (FIRSTSTEP) RTCF(NRTCF+3) = 0.0
...
! 10:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '46_1'
      CALL COMPONENT_ID(ICALL_NO,128950166)
      CALL SURGE_IEEE1_CFG(1,0,0.0,0.0,1.0,0.01)

! 20:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '46_2'
      CALL COMPONENT_ID(ICALL_NO,65469208)
      CALL SURGE_IEEE1_CFG(1,0,0.0,0.0,1.0,0.01)

! 30:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '46_3'
      CALL COMPONENT_ID(ICALL_NO,503951448)
      CALL SURGE_IEEE1_CFG(1,0,0.0,0.0,1.0,0.01)
