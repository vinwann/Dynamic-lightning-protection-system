...
! 10:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '69_1'
      IF (FIRSTSTEP) RTCF(NRTCF+3) = 0.0
      CALL SURGE_IEEE1_EXE(RT_1)

! 20:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '69_2'
      IF (FIRSTSTEP) RTCF(NRTCF+3) = 0.0
      CALL SURGE_IEEE1_EXE(RT_2)

! 30:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '69_3'
      IF (FIRSTSTEP) RTCF(NRTCF+3) = 0.0
...
! 10:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '69_1'
      CALL COMPONENT_ID(ICALL_NO,1734886298)
      CALL SURGE_IEEE1_CFG(1,0,0.0,0.0,1.0,0.01)

! 20:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '69_2'
      CALL COMPONENT_ID(ICALL_NO,878850710)
      CALL SURGE_IEEE1_CFG(1,0,0.0,0.0,1.0,0.01)

! 30:[surge1] Surge Generator (CIGRE, IEC or IEEE Std.) '69_3'
      CALL COMPONENT_ID(ICALL_NO,700435682)
      CALL SURGE_IEEE1_CFG(1,0,0.0,0.0,1.0,0.01)
