...
import os
DataSet = [[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]]
file_path1 = 'T46.gf46\T46_01.out'
file_path2 = 'T46.gf46\T46_02.out'
def assign_data_to_read():
    ...
    #dtaLength = 0
    #DataSetRead = [[], [], []]
    #DataSetRead[0] = DataSet[0]
    #DataSetRead[1] = DataSet[1]
    #DataSetRead[2] = DataSet[2]
    ...
    file_name1 = "L_4_6_"+str(num*100)+"_1.csv"
    ############################################################3
